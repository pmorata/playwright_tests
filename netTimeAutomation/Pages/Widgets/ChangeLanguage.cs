...
namespace netTimeAutomation.Pages.Widgets {
    public class ChangeLanguage {
        ...
        //public ILocator Language(Languages language) {
        //    var languageDescription = language.GetType()
        //                                     .GetField(language.ToString())
        //                                     ?.GetCustomAttributes(typeof(System.ComponentModel.DescriptionAttribute), false)
        //                                     .FirstOrDefault() as System.ComponentModel.DescriptionAttribute;
        //    return page.Locator($"[entity-id={languageDescription?.Description}]");
        //}
        
        //page.locator('#GRID_CONTAINER').getByText('Euskara')
        #endregion

        public ChangeLanguage(IPage page) {
            this.page = page;
        }
    }
}
